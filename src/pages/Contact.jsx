...
const Contact = () => {
  ...
  return (
    <>
      {/* ✅ SEO Meta Tags */}
      <Helmet>
        <title>Contact Us | Marketing.thebuildlab</title>
        <meta
          name="description"
          content="Contact Marketing.thebuildlab to discuss SEO, PPC, growth marketing and performance-driven digital strategies. Get a free strategy call."
        />
        <meta
          name="keywords"
          content="contact digital marketing agency, SEO consultation, PPC agency contact, growth marketing India"
        />
        <link
          rel="canonical"
          href="https://marketing.thebuildlab.in/contact"
        />

        {/* Open Graph */}
        <meta property="og:title" content="Contact Marketing.thebuildlab" />
        <meta
          property="og:description"
          content="Get in touch with Marketing.thebuildlab for a free strategy call and custom growth plan."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://marketing.thebuildlab.in/contact"
        />
      </Helmet>
              ...
              >
                <div className="mb-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Whether you're launching a new campaign or scaling existing efforts, our team is here to help. Fill out the form and receive a custom strategy.
                  </p>
                </div>
